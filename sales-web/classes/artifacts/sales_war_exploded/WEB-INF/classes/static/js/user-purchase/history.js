$(document).ready(function () {
    ...
    $("#detail_tb").bootstrapTable({
        url: "http://localhost:8080/sales/user-user-purchase/select",
        method: 'get',
        pagination: true, //分页
        pageSize: 8, //每页显示8条
        singleSelect: false,
...
*/
    ...
    $("#detail_tb").on('click', '.modify_sales', function (e) {
        ...
        $.ajax({
            url: 'http://locahost:8080/sales/user-user-purchase/select' + id,
            method: 'post',
            async: false,
            dataType: 'json',
            success: function (response) {
        ...
        url = "http://localhost:8080/sales/user-user-purchase/update"
    });
