$(document).ready(function () {
    ...
    $("#detail_tb").bootstrapTable({
        url: "http://localhost:8080/sales/sales/manager/receive/noengouh",
        method: 'get',
        pagination: true, //分页
        pageSize: 8, //每页显示8条
        singleSelect: false,
...
*/
    ...
    $("#detail_tb").on('click', '.modify_sales', function (e) {
        ...
        $.ajax({
            url: 'http://localhost:8080/sales/sales/manager/receive/noengouh' + id,
            method: 'get',
            async: false,
            dataType: 'json',
            success: function (response) {
        ...
        url = "http://localhost:8080/sales/sales/noenough/manager/pass"
    });
    ...
    $("#detail_tb").on('click', '.view_sales', function (e) {
        ...
        url = "http://localhost:8080/sales/sales/noenough/manager/nopass"
    });
