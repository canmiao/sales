$(document).ready(function () {
    ...
    $("#detail_tb").bootstrapTable({
        url: "http://localhost:8080/sales/sales/refund/select",
        method: 'get',
        pagination: true, //分页
        pageSize: 8, //每页显示8条
        singleSelect: false,
    ...
    $("#insert").on('click', function (e) {
        ...
        // 准备参数
        url = "http://localhost:8080/sales/sales/refund/insert"
    });
    ...
    $("#detail_tb").on('click', '.modify_sales', function (e) {
        ...
        $.ajax({
            url: 'http://localhost:8080/sales/sales/refund/select' + id,
            method: 'get',
            async: false,
            dataType: 'json',
            success: function (response) {
        ...
        url = "http://localhost:8080/sales/sales/refund/update"
    });
